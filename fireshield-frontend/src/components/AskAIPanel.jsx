...
export default function AskAIPanel({ simulation, recommendation, addLog }) {
  ...
  return (
    <section className="command-card p-4">
      <div>
        <h2 className="text-sm font-semibold uppercase tracking-[0.22em] text-cyan-300">Ask FireShield AI</h2>
        <p className="mt-1 text-sm text-slate-400">Ask about spread, road access, evacuation timing, or resource needs.</p>
      </div>
      ...
      >
        <input
          ...
          value={question}
        />
        <button className="rounded-2xl bg-cyan-400 px-4 py-2 text-sm font-semibold text-slate-950 hover:bg-cyan-300" type="submit">
          Send
        </button>
      </form>
    </section>
