  ...
  return (
    <section className="command-card">
      <div className="flex w-full items-center justify-between border-b border-slate-200/8 px-4 py-3 text-left">
        <div>
          <div className="text-sm font-semibold uppercase tracking-[0.22em] text-cyan-300">Timeline</div>
          <div className="mt-1 text-sm text-slate-400">Recent operational events</div>
        </div>
