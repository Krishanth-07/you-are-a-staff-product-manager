...
export default function App() {
  ...
  const summary = useMemo(() => {
    ...
    const evacuationTarget =
      recommendation?.evacuate?.[0]?.location ?? "Awaiting plan";
      ...
      cards: [
        {
          ...
          detail:
            riskScore == null
              ? "Run the model to generate a score."
              : "Latest simulation output from the spread model.",
        },
        {
          label: "Burned area",
          value: burnt,
        ...
        },
        {
          ...
          detail:
            confidence == null
              ? "Generate a recommendation to see confidence."
              : "Incident commander recommendation strength.",
        },
        {
          ...
          detail:
            containment == null
              ? "Generate a command plan to see the containment estimate."
              : `Containment estimate ${containment}%`,
        },
      ],
    };
          ...
          <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
            <div className="max-w-3xl space-y-3">
              ...
              <h2 className="text-2xl font-semibold text-slate-50 sm:text-3xl">
                Nilgiris wildfire response workspace
              </h2>
              <p className="max-w-2xl text-sm leading-6 text-slate-400">
                A practical command view for planning response, updating
                evacuation guidance, and keeping the model, map, and public
                messaging aligned in one place.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200/10 bg-slate-950/55 px-4 py-3">
              ...
              <div className="mt-1 text-sm text-slate-400">
                {simulation
                  ? "Latest simulation is loaded."
                  : "Waiting for the model to initialize."}
              </div>
            </div>
          </div>
